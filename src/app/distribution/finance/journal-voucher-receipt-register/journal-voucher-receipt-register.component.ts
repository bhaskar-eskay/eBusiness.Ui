...
@Component({
  ...
  templateUrl: './journal-voucher-receipt-register.component.html',
  styleUrls: ['./journal-voucher-receipt-register.component.scss']
})
export class JournalVoucherReceiptRegisterComponent implements OnInit {
    openPanel = false;
    step = 0;
    foods: Food[] = [
    ...
    journalVoucherRegisterFormGroup: FormGroup;
