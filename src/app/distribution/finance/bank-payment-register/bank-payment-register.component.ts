...
@Component({
  ...
  templateUrl: './bank-payment-register.component.html',
  styleUrls: ['./bank-payment-register.component.scss']
})
export class BankPaymentRegisterComponent implements OnInit {
    openPanel = false;
    step = 0;
    foods: Food[] = [
    ...
    bankPaymentRegisterFormGroup: FormGroup;
