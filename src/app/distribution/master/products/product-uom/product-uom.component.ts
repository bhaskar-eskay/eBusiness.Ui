...
@Component({
  selector: 'app-product-uom',
  templateUrl: './product-uom.component.html',
  styleUrls: ['./product-uom.component.scss','../../master.component.scss']
})

export class ProductUomComponent implements OnInit {
  type=ProdMasterTypeEnum.PROD_UOM;
  ...
  save() {
    ...
    if(!updatedObj.prodMasterType){
      updatedObj.prodMasterType = 'PROD_UOM';
    }
