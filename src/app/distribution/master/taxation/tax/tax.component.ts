...
import { ActionStyle } from 'src/app/shared/components/table/table-model';
...
@Component({
  ...
  styleUrls: ['./tax.component.scss', '../../master.component.scss']
})
export class TaxComponent implements OnInit {
  ...
  tableDefinition:TableDefinition={
    columns:[
      {id:"type",  name:"Country", value:(obj)=>obj['country']},
      {id:"slab",  name:"Type", value:(obj)=>obj['typename']},
  ...
  private getAllSlabs() {
    ...
    this.dataList = [{country:'India' , typename:'GST' , activeDate:'01-07-2017'}]
  }
