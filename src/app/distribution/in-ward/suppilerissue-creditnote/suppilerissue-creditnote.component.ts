...
@Component({
  selector: 'app-suppilerissue-creditnote',
  templateUrl: './suppilerissue-creditnote.component.html',
  styleUrls: ['./suppilerissue-creditnote.component.scss', '../in-ward.component.scss']
})
export class SuppilerissueCreditnoteComponent implements OnInit {
