...
@Component({
  selector: 'app-suppilerissue-debitnote',
  templateUrl: './suppilerissue-debitnote.component.html',
  styleUrls: ['./suppilerissue-debitnote.component.scss', '../in-ward.component.scss']
})
export class SuppilerissueDebitnoteComponent implements OnInit {
