...
@Component({
  selector: 'app-internalstockadjustment',
  templateUrl: './internalstockadjustment.component.html',
  styleUrls: ['./internalstockadjustment.component.scss', '../in-ward.component.scss']
})
export class InternalstockadjustmentComponent implements OnInit {
