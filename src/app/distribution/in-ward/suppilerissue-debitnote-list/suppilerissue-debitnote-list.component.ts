...
@Component({
  selector: 'app-suppilerissue-debitnote-list',
  templateUrl: './suppilerissue-debitnote-list.component.html',
  styleUrls: ['./suppilerissue-debitnote-list.component.scss', '../in-ward.component.scss']
})
export class SuppilerissueDebitnoteListComponent implements OnInit {
