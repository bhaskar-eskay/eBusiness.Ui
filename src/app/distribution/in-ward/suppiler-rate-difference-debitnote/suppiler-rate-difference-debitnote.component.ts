...
@Component({
  selector: 'app-suppiler-rate-difference-debitnote',
  templateUrl: './suppiler-rate-difference-debitnote.component.html',
  styleUrls: ['./suppiler-rate-difference-debitnote.component.scss', '../in-ward.component.scss']
})
export class SuppilerRateDifferenceDebitnoteComponent implements OnInit {
