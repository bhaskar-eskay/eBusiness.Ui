...
@Component({
  selector: 'app-suppiler-rate-difference-creditnote-list',
  templateUrl: './suppiler-rate-difference-creditnote-list.component.html',
  styleUrls: ['./suppiler-rate-difference-creditnote-list.component.scss', '../in-ward.component.scss']
})
export class SuppilerRateDifferenceCreditnoteListComponent implements OnInit {
