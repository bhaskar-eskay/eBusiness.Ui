...
@Component({
  ...
  templateUrl: './other-sales-list.component.html',
  styleUrls: ['./other-sales-list.component.scss', '../out-ward.component.scss']
})
export class OtherSalesListComponent implements OnInit {
