...
@Component({
  ...
  templateUrl: './general-credit-note-customer-list.component.html',
  styleUrls: ['./general-credit-note-customer-list.component.scss', '../out-ward.component.scss']
})
export class GeneralCreditNoteCustomerListComponent implements OnInit {
