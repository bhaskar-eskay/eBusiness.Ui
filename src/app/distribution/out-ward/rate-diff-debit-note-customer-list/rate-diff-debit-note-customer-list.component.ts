...
@Component({
  ...
  templateUrl: './rate-diff-debit-note-customer-list.component.html',
  styleUrls: ['./rate-diff-debit-note-customer-list.component.scss', '../out-ward.component.scss']
})
export class RateDiffDebitNoteCustomerListComponent implements OnInit {
  constructor() { }
