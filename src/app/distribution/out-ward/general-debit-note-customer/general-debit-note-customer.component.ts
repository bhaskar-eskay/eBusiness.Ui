...
@Component({
  ...
  templateUrl: './general-debit-note-customer.component.html',
  styleUrls: ['./general-debit-note-customer.component.scss', '../out-ward.component.scss']
})
export class GeneralDebitNoteCustomerComponent implements OnInit {
  
  generalDebitNoteCustomerHeadFormGroup: FormGroup;
  
  generalDebitNoteCustomerDetailFormGroup: FormGroup;
