...
@Component({
  ...
  templateUrl: './rate-diff-credit-note-customer-list.component.html',
  styleUrls: ['./rate-diff-credit-note-customer-list.component.scss', '../out-ward.component.scss']
})
export class RateDiffCreditNoteCustomerListComponent implements OnInit {
